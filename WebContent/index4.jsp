...
<!--content-->
<div class="container padBot" style="height: 400px;background-image: url('figures/pmain.png');"><br><br>
    <div class="row">
        ...
        <article class="span8 about-box" style="">
            <h5 style="color: Silver;margin-top: 180px;margin-left: -60px; font-size:50px;"><i>Welcome, Administrator!</i></h5>
